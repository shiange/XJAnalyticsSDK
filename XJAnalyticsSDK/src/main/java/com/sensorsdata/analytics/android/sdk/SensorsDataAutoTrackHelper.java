...
import com.xjdata.analytics.android.sdk.AppStateManager;
import com.xjdata.analytics.android.sdk.AppWebViewInterface;
import com.xjdata.analytics.android.sdk.R;
import com.xjdata.analytics.android.sdk.XJAdapterViewItemTrackProperties;
import com.xjdata.analytics.android.sdk.XJAutoTracker;
import com.xjdata.analytics.android.sdk.XJDataAPI;
import com.xjdata.analytics.android.sdk.XJDataAPIEmptyImplementation;
import com.xjdata.analytics.android.sdk.XJExpandableListViewItemTrackProperties;
...
import com.xjdata.analytics.android.sdk.util.ThreadUtils;
import com.xjdata.analytics.android.sdk.util.ViewUtil;
import com.xjdata.analytics.android.sdk.util.WindowHelper;
import com.xjdata.analytics.android.sdk.visual.WebViewVisualInterface;
import com.xjdata.analytics.android.sdk.visual.util.VisualUtil;
...
public class SensorsDataAutoTrackHelper {
    ...
    public static void trackRN(Object target, int reactTag, int s, boolean b) {
        try {
            if (!XJDataAPI.sharedInstance().isReactNativeAutoTrackEnabled()) {
                return;
            }

            //关闭 AutoTrack
            if (!XJDataAPI.sharedInstance().isAutoTrackEnabled()) {
                return;
            }

            //$AppClick 被过滤
            if (XJDataAPI.sharedInstance().isAutoTrackEventTypeIgnored(XJDataAPI.AutoTrackEventType.APP_CLICK)) {
                return;
            }
            ...
            if (target != null) {
                ...
                if (resolveViewMethod != null) {
                    ...
                    if (object != null) {
                        ...
                        //$screen_name & $title
                        if (activity != null) {
                            XJDataUtils.mergeJSONObject(AopUtil.buildTitleAndScreenName(activity), properties);
            ...
            XJDataAPI.sharedInstance().trackAutoEvent(AopConstants.APP_CLICK_EVENT_NAME, properties);
        } catch (Exception e) {
            XJLog.printStackTrace(e);
        }
    }
    ...
    private static void trackFragmentAppViewScreen(Object fragment) {
        try {
            if (XJDataAPI.sharedInstance().isAutoTrackEventTypeIgnored(XJDataAPI.AutoTrackEventType.APP_VIEW_SCREEN)) {
                return;
            }

            if (!XJDataAPI.sharedInstance().isTrackFragmentAppViewScreenEnabled()) {
                return;
            }
            ...
            boolean isAutoTrackFragment = XJDataAPI.sharedInstance().isFragmentAutoTrackAppViewScreen(fragment.getClass());
            ...
            XJDataAPI.sharedInstance().trackViewScreen(XJDataUtils.getScreenUrl(fragment), eventProperties);
        } catch (Exception e) {
            XJLog.printStackTrace(e);
        }
    }
    ...
    public static void trackExpandableListViewOnGroupClick(ExpandableListView expandableListView, View view,
        ...
        try {
            ...
            //Activity 被忽略
            if (activity != null) {
                if (XJDataAPI.sharedInstance().isActivityAutoTrackAppClickIgnored(activity.getClass())) {
                    return;
                }
            }
            ...
            // fragment 忽略
            if (fragment != null) {
                if (XJDataAPI.sharedInstance().isActivityAutoTrackAppClickIgnored(fragment.getClass())) {
                    return;
                }
            }
            ...
            if (listAdapter != null) {
                if (listAdapter instanceof XJExpandableListViewItemTrackProperties) {
                    try {
                        XJExpandableListViewItemTrackProperties trackProperties = (XJExpandableListViewItemTrackProperties) listAdapter;
    ...
    public static void trackTabLayoutSelected(Object object, Object tab) {
        try {
            ...
            if (isFragment) {
                if (XJDataAPI.sharedInstance().isActivityAutoTrackAppClickIgnored(object.getClass())) {
                    return;
                }
            }
    ...
    public static void trackListView(AdapterView<?> adapterView, View view, int position) {
        try {
            ...
            if (adapter instanceof XJAdapterViewItemTrackProperties) {
                try {
                    XJAdapterViewItemTrackProperties objectProperties = (XJAdapterViewItemTrackProperties) adapter;
    ...
    public static void trackDrawerOpened(View view) {
        try {
            ...
            XJDataAPI.sharedInstance().setViewProperties(view, jsonObject);
    ...
    public static void trackViewOnClick(View view, boolean isFromUser) {
        try {
            ...
            if (XJDataUtils.isDoubleClick(view)) {
                return;
            }
    ...
    public static void track(String eventName, String properties) {
        try {
            ...
            XJDataAPI.sharedInstance().trackInternal(eventName, pro);
        } catch (Exception e) {
            XJLog.printStackTrace(e);
        }
    }
    ...
    public static void showChannelDebugActiveDialog(final Activity activity) {
        XJDataDialogUtils.showDialog(activity, "成功开启调试模式",
                "此模式下不需要卸载 App，点击“激活”按钮可反复触发激活", "激活", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        XJDataAPI.sharedInstance().trackChannelDebugInstallation();
    ...
    public static void loadUrl2(View webView, String url) {
        if (webView == null) {
            XJLog.i(TAG, "WebView has not initialized.");
            return;
        }
    ...
    private static void setupH5Bridge(View webView) {
        if (XJDataAPI.sharedInstance() instanceof XJDataAPIEmptyImplementation) {
            return;
        }
        if (isSupportJellyBean() && XJDataAPI.sharedInstance().getConfigOptions() != null && XJDataAPI.sharedInstance().getConfigOptions().isAutoTrackWebView) {
    ...
    public static void addWebViewVisualInterface(View webView) {
    ...
    private static boolean isSupportJellyBean() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN_MR1 && !XJDataAPI.sharedInstance().getConfigOptions().isWebViewSupportJellyBean) {
    ...
    private static void setupWebView(View webView) {
        if (webView != null && webView.getTag(R.id.sensors_analytics_tag_view_webview) == null) {
            ...
            addJavascriptInterface(webView, new AppWebViewInterface(XJDataAPI.sharedInstance().getContext(), null, false, webView), "SensorsData_APP_New_H5_Bridge");
        }
    }
