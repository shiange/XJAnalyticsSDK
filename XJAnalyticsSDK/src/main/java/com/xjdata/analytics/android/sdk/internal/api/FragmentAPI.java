 ...
 */
package com.xjdata.analytics.android.sdk.internal.api;

import android.text.TextUtils;

import com.xjdata.analytics.android.sdk.XJLog;
import com.xjdata.analytics.android.sdk.XJDataAPI;
import com.xjdata.analytics.android.sdk.XJDataIgnoreTrackAppViewScreen;
import com.xjdata.analytics.android.sdk.XJDataIgnoreTrackAppViewScreenAndAppClick;
...
public class FragmentAPI implements IFragmentAPI {
    ...
    public boolean isFragmentAutoTrackAppViewScreen(Class<?> fragment) {
        ...
        try {
            ...
            if (fragment.getAnnotation(XJDataIgnoreTrackAppViewScreen.class) != null) {
                return false;
            }

            if (fragment.getAnnotation(XJDataIgnoreTrackAppViewScreenAndAppClick.class) != null) {
                return false;
            }
