...
public class DbAdapter {
    ...
    private DbAdapter(Context context, String packageName, XJDataEncrypt XJDataEncrypt) {
        mDbParams = DbParams.getInstance(packageName);
        if (XJDataEncrypt != null) {
            mTrackEventOperation = new EncryptDataOperation(context.getApplicationContext(), XJDataEncrypt);
        } else {
    ...
    public static DbAdapter getInstance(Context context, String packageName,
                                        XJDataEncrypt XJDataEncrypt) {
        if (instance == null) {
            instance = new DbAdapter(context, packageName, XJDataEncrypt);
        }
        return instance;
    }
