...
public class XJDataLoadingDialog extends Dialog {

    private RelativeLayout mLoadingLayout;

    public XJDataLoadingDialog(Context context) {
        super(context);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (window != null) {
            ...
            p.height = XJDisplayUtil.dip2px(getContext(), 98);
            p.width = XJDisplayUtil.dip2px(getContext(), 88);
