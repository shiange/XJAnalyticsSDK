...
package com.xjdata.analytics.android.sdk.deeplink;
...
public class DeepLinkManager {
    ...
    private static DeepLinkProcessor createDeepLink(Intent intent, String serverUrl) {
        ...
        if (isSensorsDataDeepLink(intent, new ServerUrl(serverUrl).getHost())) {
            return new XJDataDeepLink(intent, serverUrl);
        }
    ...
    private static void trackDeepLinkLaunchEvent(DeepLinkProcessor deepLink) {
        ...
        XJDataUtils.mergeJSONObject(ChannelUtils.getUtmProperties(), properties);
        XJDataAPI.sharedInstance().track("$AppDeeplinkLaunch", properties);
    }
    ...
    public static boolean parseDeepLink(final Activity activity, final boolean isSaveDeepLinkInfo, final XJDataDeepLinkCallback callback) {
        try {
            Intent intent = activity.getIntent();
            mDeepLinkProcessor = createDeepLink(intent, XJDataAPI.sharedInstance().getServerUrl());
