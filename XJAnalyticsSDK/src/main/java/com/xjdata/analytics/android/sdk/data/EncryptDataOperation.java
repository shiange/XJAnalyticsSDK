/*
 * Created by dengshiwei on 2020/05/20.
...
class EncryptDataOperation extends DataOperation {
    ...
    private XJDataEncrypt mXJDataEncrypt;

    EncryptDataOperation(Context context, XJDataEncrypt XJDataEncrypt) {
        super(context);
        this.mXJDataEncrypt = XJDataEncrypt;
    }
    ...
    int insertData(Uri uri, JSONObject jsonObject) {
        try {
            ...
            jsonObject = mXJDataEncrypt.encryptTrackData(jsonObject);
