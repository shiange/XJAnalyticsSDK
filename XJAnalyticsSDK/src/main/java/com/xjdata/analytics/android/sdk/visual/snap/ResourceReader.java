...
package com.xjdata.analytics.android.sdk.visual.snap;
...
public abstract class ResourceReader implements ResourceIds {
    ...
    private static void readClassIds(Class<?> platformIdClass, String namespace,
        ...
        try {
            ...
            XJLog.i(TAG, "Can't read built-in id names from " + platformIdClass.getName(), e);
        }
    }
    ...
    protected void initialize() {
        ...
        try {
            ...
            XJLog.i(TAG, "Can't load names for Android view ids from '" + localClassName
