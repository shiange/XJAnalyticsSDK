...
import com.xjdata.analytics.android.sdk.data.persistent.PersistentAppEndData;
import com.xjdata.analytics.android.sdk.data.persistent.PersistentAppPaused;
import com.xjdata.analytics.android.sdk.data.persistent.PersistentAppStartTime;
import com.xjdata.analytics.android.sdk.data.persistent.PersistentFlushDataState;
import com.xjdata.analytics.android.sdk.data.persistent.PersistentLoginId;
...
public class XJDataContentProvider extends ContentProvider {
    ...
    private XJDataDBHelper dbHelper;
    ...
    public boolean onCreate() {
        ...
        if (context != null) {
            ...
            try {
                ...
                packageName = "com.xjdata.analytics.android.sdk.test";
            }
            String authority = packageName + ".XJDataContentProvider";
            ...
            dbHelper = new XJDataDBHelper(context);
    ...
    private Cursor query(int code) {
        ...
        switch (code) {
            ...
            case LOGIN_ID:
                ...
                break;
            case FLUSH_DATA:
                synchronized (XJDataContentProvider.class) {
