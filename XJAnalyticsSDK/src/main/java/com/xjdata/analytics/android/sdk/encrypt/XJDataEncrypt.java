...
package com.xjdata.analytics.android.sdk.encrypt;
...
public class XJDataEncrypt {
    ...
    public XJDataEncrypt(Context context, IPersistentSecretKey persistentSecretKey) {
    ...
    public void saveSecretKey(String publicKey, int version) {
        try {
            ...
            XJLog.i(TAG, "[saveSecretKey] publicKey = " + publicKey + " ,v = " + version);
    ...
    private void saveLocalSecretKey(String key) {
        SharedPreferences preferences = XJDataUtils.getSharedPreferences(mContext);
    ...
    private SecreteKey readAppKey() {
        ...
        XJLog.i(TAG, "readAppKey [key = " + publicKey + " ,v = " + keyVersion + "]");
    ...
    private SecreteKey readLocalKey() throws JSONException {
        String publicKey = null;
        int keyVersion = 0;
        final SharedPreferences preferences = XJDataUtils.getSharedPreferences(mContext);
        ...
        XJLog.i(TAG, "readLocalKey [key = " + publicKey + " ,v = " + keyVersion + "]");
        return new SecreteKey(publicKey, keyVersion);
    }
