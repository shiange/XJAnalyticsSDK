...
public class DbParams {
    ...
    private DbParams(String packageName) {
        mUri = Uri.parse("content://" + packageName + ".XJDataContentProvider/" + TABLE_EVENTS);
        mActivityStartCountUri = Uri.parse("content://" + packageName + ".XJDataContentProvider/" + TABLE_ACTIVITY_START_COUNT);
        mAppStartTimeUri = Uri.parse("content://" + packageName + ".XJDataContentProvider/" + TABLE_APP_START_TIME);
        mAppEndDataUri = Uri.parse("content://" + packageName + ".XJDataContentProvider/" + TABLE_APP_END_DATA);
        mAppEndUri = Uri.parse("content://" + packageName + ".XJDataContentProvider/" + TABLE_APP_END_TIME);
        mSessionTimeUri = Uri.parse("content://" + packageName + ".XJDataContentProvider/" + TABLE_SESSION_INTERVAL_TIME);
        mLoginIdUri = Uri.parse("content://" + packageName + ".XJDataContentProvider/" + TABLE_LOGIN_ID);
        mChannelPersistentUri = Uri.parse("content://" + packageName + ".XJDataContentProvider/" + TABLE_CHANNEL_PERSISTENT);
        mSubProcessUri = Uri.parse("content://" + packageName + ".XJDataContentProvider/" + TABLE_SUB_PROCESS_FLUSH_DATA);
        mFirstProcessUri = Uri.parse("content://" + packageName + ".XJDataContentProvider/" + TABLE_FIRST_PROCESS_START);
        mDataCollectUri = Uri.parse("content://" + packageName + ".XJDataContentProvider/" + TABLE_DATA_COLLECT);
    }
