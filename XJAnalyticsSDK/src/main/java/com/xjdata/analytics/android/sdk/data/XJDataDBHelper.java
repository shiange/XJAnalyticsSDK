...
class XJDataDBHelper extends SQLiteOpenHelper {
    ...
    XJDataDBHelper(Context context) {
        super(context, DbParams.DATABASE_NAME, null, DbParams.DATABASE_VERSION);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        XJLog.i(TAG, "Creating a new Sensors Analytics DB");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        XJLog.i(TAG, "Upgrading app, replacing Sensors Analytics DB");
