...
public interface IXJDataAPI extends IFragmentAPI {
    /**
     * 返回预置属性
     *
     ...
     */
    void enableAutoTrack(List<XJDataAPI.AutoTrackEventType> eventTypeList);
     ...
     */
    void disableAutoTrack(List<XJDataAPI.AutoTrackEventType> eventTypeList);
     ...
     */
    void disableAutoTrack(XJDataAPI.AutoTrackEventType autoTrackEventType);
     ...
     */
    @Deprecated
    void ignoreAutoTrackEventType(XJDataAPI.AutoTrackEventType autoTrackEventType);
     ...
     */
    @Deprecated
    void ignoreAutoTrackEventType(List<XJDataAPI.AutoTrackEventType> eventTypeList);
     ...
     */
    boolean isAutoTrackEventTypeIgnored(XJDataAPI.AutoTrackEventType eventType);
    ...
    /**
     * 获取当前用户的匿名 ID
     * 若调用前未调用 {@link #identify(String)} 设置用户的匿名 ID，SDK 会优先调用 {@link com.xjdata.analytics.android.sdk.util.XJDataUtils#getAndroidID(Context)}获取 Android ID，
    ...
    /**
     *
     * @param quoteId 当前投放的 渠道id，不能为空，且长度不能大于 255
     */
    void quoteId(String quoteId);
     ...
     */
    void registerDynamicSuperProperties(XJDataDynamicSuperProperties dynamicSuperProperties);
     ...
     */
    void setTrackEventCallBack(XJDataTrackEventCallBack trackEventCallBack);
     ...
     */
    void setDeepLinkCallback(XJDataDeepLinkCallback deepLinkCallback);
    ...
    /**
     *
     * 分享者信息接口：/api/bury/wxshare
     * @param shareUUid     分享者用户唯一标识uuid
     * @param fromSharePageUrl       分享者分享页面地址
     * @param fromSharePageName     分享者分享页面名称
     * @param from  分享方式
     * @param url  被分享打开路径
     */
    void apiBuryWxshare(String shareUUid,String fromSharePageUrl,String fromSharePageName,String from,String url);
     ...
     * @param fromSharePageName    分享者分享页面名称
     * @param url  当前页面路径
     * @param systemid   Systemid业务系统中自己的id
     ...
     * @param mobile  用户手机号
     * @param email 用户邮箱
     * @param sex  性别 男1 女2 未知0
     */
    void apiBuryWxuser(String shareUUid,String fromSharePageUrl,String fromSharePageName,String url,String systemid,String unionid,String openid,String nickName
    ,String headImgUrl,String mobile,String email,String sex);

    /**
     * 上报事件接口
     */
    void apiBuryWxevent(String eventId);
    void apiBuryWxevent(String eventId,JSONObject attribute);
    /**
