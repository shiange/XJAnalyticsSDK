...
public class XJDataAPIEmptyImplementation extends XJDataAPI {
    XJDataAPIEmptyImplementation() {
    ...
    @Override
    public void disableAutoTrack(XJDataAPI.AutoTrackEventType autoTrackEventType) {
    ...
    @Deprecated
    @Override
    public void ignoreAutoTrackEventType(XJDataAPI.AutoTrackEventType autoTrackEventType) {
    ...
    @Override
    public boolean isAutoTrackEventTypeIgnored(XJDataAPI.AutoTrackEventType eventType) {
        return true;
    }
    ...
    @Override
    public void addSAJSListener(XJJSListener listener) {
