...
class XJDataDeepLink extends AbsDeepLink {
    ...
    public XJDataDeepLink(Intent intent, String serverUrl) {
        super(intent);
            ...
            new RequestHelper.Builder(HttpMethod.GET, getRequestUrl())
                    ...
                    .callback(new HttpCallback.JsonCallback() {
                        ...
                        public void onAfter() {
                            ...
                            XJDataAPI.sharedInstance().track("$AppDeeplinkMatchedResult", properties);
                        }
                    }).execute();
        }
    }
