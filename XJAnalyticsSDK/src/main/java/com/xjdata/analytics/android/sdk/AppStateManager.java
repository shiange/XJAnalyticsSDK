        ...
        try {
            ...
            if (getParentFragmentMethod != null) {
                ...
                if (parentFragment == null) {
                    ...
                    XJLog.i(TAG, "setFragmentScreenName | " + fragmentScreenName + " is not nested fragment and set");
                } else {
                    XJLog.i(TAG, "setFragmentScreenName | " + fragmentScreenName + " is nested fragment and ignored");
                }
            }
        } catch (Exception e) {
            //ignored
