...
import com.xjdata.analytics.android.sdk.util.ReflectUtil;
import com.xjdata.analytics.android.sdk.util.ViewUtil;
import com.xjdata.analytics.android.sdk.util.WindowHelper;
import com.xjdata.analytics.android.sdk.visual.model.SnapInfo;
import com.xjdata.analytics.android.sdk.visual.model.ViewNode;
import com.xjdata.analytics.android.sdk.visual.model.WebNode;
import com.xjdata.analytics.android.sdk.visual.model.WebNodeInfo;
import com.xjdata.analytics.android.sdk.visual.snap.PropertyDescription;
import com.xjdata.analytics.android.sdk.visual.snap.ResourceIds;
import com.xjdata.analytics.android.sdk.visual.snap.SoftWareCanvas;
import com.xjdata.analytics.android.sdk.visual.snap.UIThreadSet;
import com.xjdata.analytics.android.sdk.visual.util.Dispatcher;
...
@TargetApi(XJDataAPI.VTRACK_SUPPORTED_MIN_API)
public class ViewSnapshot {
    ...
    public synchronized SnapInfo snapshots(UIThreadSet<Activity> liveActivities, OutputStream out, StringBuilder lastImageHash) throws IOException {
        ...
        try {
            ...
            XJLog.i(TAG, "Screenshot interrupted, no screenshot will be sent.", e);
        } catch (final TimeoutException e) {
            XJLog.i(TAG, "Screenshot took more than 1 second to be scheduled and executed. No screenshot will be sent.", e);
        } catch (final ExecutionException e) {
            XJLog.i(TAG, "Exception thrown during screenshot attempt", e);
        }
    ...
    public static class AlertRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (webNodeInfo == null) {
                XJLog.i(TAG, "H5 页面未集成 Web JS SDK");
    ...
    private void snapshotView(final JsonWriter j, final View view, int viewIndex)
        ...
        if (ViewUtil.isViewSelfVisible(view)) {
            ...
            if (ViewUtil.instanceOfWebView(view)) {
                ...
                XJLog.i(TAG, "WebView url: " + mSnapInfo.webViewUrl);
        ...
        public synchronized void recreate(int width, int height, int destDensity, Bitmap source) {
            ...
            if (null != mCached) {
                ...
                try {
                    ...
                    XJLog.i(TAG, "CachedBitmap.recreate;Create image_hash error=" + e);
                }
            }
        }
